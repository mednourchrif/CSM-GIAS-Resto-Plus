...
class _SuccessScreenState extends ConsumerState<SuccessScreen>
  ...
  void initState() {
    ...
    final configuredDelay = ref.read(appSettingsProvider).autoReturnDelay;
    _redirectDelay = Duration(seconds: configuredDelay.clamp(2, 30).toInt());
    ...
    _contentSlide = Tween<Offset>(begin: const Offset(0, 20), end: Offset.zero)
        .animate(
          CurvedAnimation(parent: _contentController, curve: AppCurves.enter),
        );
                            ...
                            return Stack(
                              ...
                              children: [
                                ...
                                Transform.scale(
                                  ...
                                  child: Opacity(
                                    opacity: (1 - _ringExpand.value).clamp(
                                      0,
                                      1,
                                    ),
                                    child: Container(
