...
class AppShadows {
  ...
  static const List<BoxShadow> xl = [
    BoxShadow(color: Color(0x1F000000), blurRadius: 56, offset: Offset(0, 16)),
  ...
  static const List<BoxShadow> primaryGlow = [
    BoxShadow(color: Color(0x33073F68), blurRadius: 12, offset: Offset(0, 4)),
  ];

  /// Success-colored glow — for the success screen.
  static const List<BoxShadow> successGlow = [
    BoxShadow(color: Color(0x331B8A1B), blurRadius: 20, offset: Offset(0, 6)),
  ];

  /// Secondary (warm amber-orange) glow — for accent CTAs.
  static const List<BoxShadow> secondaryGlow = [
    BoxShadow(color: Color(0x33D99B00), blurRadius: 12, offset: Offset(0, 4)),
  ];
